...
Java_com_blanktrack_wakeup_androidsystemimpl_WakeUpNative_wakeUpInitial(JNIEnv *env,
                                                                            jobject instance,
                                                                            jstring wakeUpWd_,
                                                                            jstring sFile_,
                                                                            jint mode) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_blanktrack_wakeup_androidsystemimpl_WakeUpNative_wakeUpReset(JNIEnv *env,
                                                                          jobject instance) {
    return WakeUpReset();
}
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_blanktrack_wakeup_androidsystemimpl_WakeUpNative_wakeUpDecode(JNIEnv *env,
                                                                           jobject instance,
                                                                           jshortArray data_,
                                                                           jint dataLen,
                                                                           jstring senArr_,
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_blanktrack_wakeup_androidsystemimpl_WakeUpNative_wakeUpFree(JNIEnv *env,
                                                                         jobject instance) {
    LOG_D("WakeUpFree");
    return WakeUpFree();
}